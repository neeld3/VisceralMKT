    ...
    <>
      ...
      <main className="">
        ...
        <div className="mb-24 flex justify-center">
          <a href="#" className="inline-flex items-center px-12 font-permanent-marker text-5xl text-white bg-custom-color hover:bg-custom-color focus:ring-4 focus:ring-custom-color font-medium rounded-full p-12 text-center shadow-lg transition-colors dark:bg-custom-color dark:hover:bg-custom-color dark:focus:ring-custom-color">
            <CursorArrowRaysIcon className="h-16 w-16 text-white mr-5" aria-hidden="true" />
            Join the Community
          </a>
        </div>

        <a href="#" className="inline-flex items-center font-permanent-marker fixed top-4 right-4 z-50 text-white bg-custom-color hover:bg-custom-color focus:ring-4 focus:ring-custom-color font-medium rounded-full text-lg px-6 py-6 text-center shadow-lg transition-colors dark:bg-custom-color dark:hover:bg-custom-color dark:focus:ring-custom-color">
